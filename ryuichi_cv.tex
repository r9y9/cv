...
\begin{EntriesTable}
  ...
  \Appointment{Senior Research Scientist}{Speech and Acoustic AI}{LY Corporation, Tokyo, Japan}
  \\
  \Duration{2021}{2023}  &
...
\begin{EntriesTable}
  \Year{2024}
  &
  Masaya Kawamura, \textbf{Ryuichi Yamamoto}, Yuma Shirahata, Takuya Hasumi, Kentaro Tachibana, ``LibriTTS-P: A Corpus with Speaking Style and Speaker Identity Prompts for Text-to-Speech and Style Captioning," \emph{Proc. Interspeech}, pp. xxxx--xxxx, 2024.
  \Website{https://masayakawamura.github.io/libritts-p/}
  \GitHub{line/LibriTTS-P}
  \\
  ~ &
  Yuma Shirahata, Byeongseon Park, \textbf{Ryuichi Yamamoto}, Kentaro Tachibana, ``Audio-conditioned phonemic and prosodic annotation for building text-to-speech models from unlabeled speech data," \emph{Proc. Interspeech}, pp. xxxx--xxxx, 2024.
  \Website{yshira116.github.io/pp\_annotation/}
  \\
  ~ &
  Yuki Saito, Takuto Igarashi, Kentaro Seki, Shinnosuke Takamichi, \textbf{Ryuichi Yamamoto}, Kentaro Tachibana, Hiroshi Saruwatari, ``SRC4VC: Smartphone-Recorded Corpus for Voice Conversion Benchmark," \emph{Proc. Interspeech}, pp. xxxx--xxxx, 2024.
  \Website{y-saito.sakura.ne.jp/sython/Corpus/SRC4VC/index.html}
  \\
  ~ &
  Takuto Igarashi, Yuki Saito, Kentaro Seki, Shinnosuke Takamichi, \textbf{Ryuichi Yamamoto}, Kentaro Tachibana, Hiroshi Saruwatari, ``Noise-Robust Voice Conversion by Conditional Denoising Training Using Latent Variables of Recording Quality and Environment," \emph{Proc. Interspeech}, pp. xxxx--xxxx, 2024.
  \Website{y-saito.sakura.ne.jp/sython/Corpus/SRC4VC/IS2024\_CDT\_supplementary/demo\_cdt.html}
  \\
  ~ &
  Yongyi Zang, Jiatong Shi, You Zhang, \textbf{Ryuichi Yamamoto}, Jionghao Han, Yuxun Tang, Shengyuan Xu, Wenxiao Zhao, Jing Guo, Tomoki Toda, Zhiyao Duan, ``CtrSVDD: A Benchmark Dataset and Baseline Analysis for Controlled Singing Voice Deepfake Detection," \emph{Proc. Interspeech}, pp. xxxx--xxxx, 2024.
